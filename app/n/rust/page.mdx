...
## rust kya Hei? rust developers ko Tez software likhne me Hepl krTa Hei zo memory-efficient Hei. yH code safety or concise syntax pr focus Dene ke saTh c++ ya c zeisi bhasao ka ek modern replacement Hei. rust javascript se kafi Alg Hei. javascript upyog me n Aane vale vAriAbles ya objects ko dhundhne ka pryas krTa Hei or svcaliT rup se unHe memori se saf kr DeTa Hei. ise[garbAge collection](<https://en.wikipedia.org/wiki/Garbage_collection_(computer_science)>) kHa zaTa Hei. rust bhasa developers ko mAnuAl memory prbnDhn ke bare me socne se rokTi Hei. rst ke saTh, developers ke pas memory allocation pr ADhik control HoTa Hei, yH c++ ziTna mushkil nHi HoTa Hei.
